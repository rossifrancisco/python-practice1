...
# COMPLETAR - INICIO
suma_de_numeros=int(numero_04)+ int(numero_03)+ int(numero_02)+ int(numero_01)
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
resultado_resta = int(numero_01)-int(numero_02,16)
resultado_resta = resultado_resta - int(numero_03,8)
resultado_resta = resultado_resta - numero_04
# COMPLETAR - FIN
